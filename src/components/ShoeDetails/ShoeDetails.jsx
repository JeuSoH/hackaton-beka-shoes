        ...
        {editStatus ? (
          ...
          <>
            ...
            <div className="det_title">
              ...
              <p className="det_brand">{shoeDetails.category} /</p>
            ...
            <div className="det_welcome">
              ...
              <div className="det_inf">
                <p className="det_price">{shoeDetails.price} $</p>
                <p className="det_color">Цвет:{shoeDetails.color}</p>
                <p className="det_color">Пол:{shoeDetails.sex}</p>
                <p className="det_size">Таблица размеров: {shoeDetails.size}</p>
                <button className="btn_inf">Добавить в корзину</button>
                <p className="inf_dost">Доставка:в течении недeли</p>
                <p className="inf_dost">Склад отгрузки:склад StreetHead </p>
                <p className="det_size">Продавец:StreetHead OOO</p>
                ...
                <div className="inf_desc">
                  <div className="inf_block">
                    ...
                    <p className="cloth_desc">Бесплатная доставка</p>
                  </div>
                  <div className="inf_block">
                    <img className="cloth_icon" src={Clothes} />
                    <p className="cloth_desc">Примерка</p>
                  </div>
                  <div className="inf_block">
                    <img className="cloth_icon" src={Exch} />
                    <p className="cloth_desc">28 день на возврат</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="det_description">
              <h1>Описание</h1>
              <p className="content_desc">{shoeDetails.description}</p>
            </div>
            <div>
